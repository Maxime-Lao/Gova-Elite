 ...
 */
final class Version20231114194127 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE car (id INT NOT NULL, gear_id INT NOT NULL, model_id INT DEFAULT NULL, energy_id INT NOT NULL, companie_id INT NOT NULL, year INT NOT NULL, horses INT NOT NULL, nb_seats INT NOT NULL, nb_doors INT NOT NULL, price DOUBLE PRECISION NOT NULL, mileage INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE companie (id INT NOT NULL, name VARCHAR(100) NOT NULL, address VARCHAR(255) NOT NULL, zip_code VARCHAR(255) NOT NULL, city VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE rent (id INT NOT NULL, car_id INT DEFAULT NULL, date_start TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_end TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, total_price INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_verified BOOLEAN DEFAULT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
