...
class Comment
{
    ...
    #[ORM\GeneratedValue]
    #[ORM\Column]
    #[Groups(['comments:read', 'comments_car:read', 'comments_user:read', 'car:read'])]
    private ?int $id = null;
    ...
    #[Groups(['comments:read', 'comments_car:read', 'car:read'])]
    ...
    #[Groups(['comments_user', 'car:read', 'comments_user:read'])]
